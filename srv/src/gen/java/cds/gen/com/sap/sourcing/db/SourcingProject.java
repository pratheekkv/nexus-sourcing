...
public interface SourcingProject extends CdsData {
  String ID = "ID";
  ...
  SourcingProject_ ref();

  static SourcingProject create() {
    return Struct.create(SourcingProject.class);
  }

  static SourcingProject create(String id) {
    Map<String, Object> keys = new HashMap<>();
    keys.put(ID, id);
    return Struct.access(keys).as(SourcingProject.class);
  }
}
