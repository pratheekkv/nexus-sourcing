...
public interface ProjectDraftPrepareContext extends EventContext {
  ...
  static ProjectDraftPrepareContext create() {
    return EventContext.create(ProjectDraftPrepareContext.class, "Sourcing.Project");
  }
  ...
  static ProjectDraftPrepareContext create(String entityName) {
    return EventContext.create(ProjectDraftPrepareContext.class, entityName);
  }
}
