...
public interface EventDraftPrepareContext extends EventContext {
  ...
  static EventDraftPrepareContext create() {
    return EventContext.create(EventDraftPrepareContext.class, "Sourcing.Event");
  }
  ...
  static EventDraftPrepareContext create(String entityName) {
    return EventContext.create(EventDraftPrepareContext.class, entityName);
  }
}
