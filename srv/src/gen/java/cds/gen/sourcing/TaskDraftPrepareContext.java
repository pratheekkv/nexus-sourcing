...
public interface TaskDraftPrepareContext extends EventContext {
  ...
  static TaskDraftPrepareContext create() {
    return EventContext.create(TaskDraftPrepareContext.class, "Sourcing.Task");
  }
  ...
  static TaskDraftPrepareContext create(String entityName) {
    return EventContext.create(TaskDraftPrepareContext.class, entityName);
  }
}
